...
export default function LocationList({ settlementId, onDelete }: LocationListProps) {
  if (!settlementId) {
      ...
      <FilteredGridView<LocationType>
        ...
        filterComponent={
          <FilterBar
            ...
            clearFilters={() => {
              setFilters({ ...DefaultLocationFilters, settlementId }); // reset to default + settlement
            }}
          >
        ...
        fabLink={`/settlements/${settlementId}/locations/new`}
      />
