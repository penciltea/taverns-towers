...
export default function GenerateSettlementPreview({settlement}: settlementProps){
    return(
        <Box>
            ...
            <Typography variant="body1"><strong>Terrain:</strong> {settlement.terrain.join(', ')}</Typography>
            ...
            <Typography variant="body1"><strong>Criminal Activity:</strong> {settlement.crime.join(', ')}</Typography>
        </Box>
    )
}