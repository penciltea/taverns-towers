...
export const SITE_THEMES = [
  {
    ...
    options: [
      ...
      { label: "Arcane / Mystic", value: "Arcane / Mystic" },
      { label: "Fey / Nature", value: "Fey / Nature" },
      { label: "Frontier / Rustic", value: "Frontier / Rustic" }
    ]
  }
];

export const ARTISAN_SITE_THEMES = [
  {
    label: "Premium-tier Exclusives",
    options: [
      { label: "Clockwork / Steampunk", value: "Clockwork / Steampunk" },
      { label: "Dark / Gothic", value: "Dark / Gothic" },
      { label: "Arabic-Inspired", value: "Arabic-Inspired" },
      { label: "Nordic-Inspired", value: "Nordic-Inpsired" }
    ]
  }
];
...
export const ENTERTAINMENT_VENUE_TYPES = [
  { label: "Arena / Coliseum", value: "arena" },
  { label: "Bardic College", value: "bard" },
  { label: "Bathhouse", value: "bathhouse" },
  { label: "Brothel", value: "brothel" },
  { label: "Circus Tent", value: "circusTent" },
  { label: "Duelling Ring", value: "duel" },
  { label: "Festival Grounds", value: "festival" },
  { label: "Gambling Den", value: "gambling" },
  { label: "Magical Spectacle Venue", value: "magic" },
  { label: "Music Hall", value: "music" },
  { label: "Racing Track", value: "racing" },
  { label: "Street Performance Zone", value: "street" },
  { label: "Theater", value: "theater" },
  { label: "Underground Fight Pit", value: "fightingPit" },
  { label: "Other", value: "other" },
];
