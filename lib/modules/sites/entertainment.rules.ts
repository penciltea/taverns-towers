...
async function applySizeRule(data: NormalizedEntertainmentInput) {
...
async function applyConditionRule(data: NormalizedEntertainmentInput) {
...
export async function generateEntertainmentValues(input: SiteGenerationInput): Promise<SiteFormData> {
