...
function applySizeRule(data: NormalizedResidenceInput) {
...
function applyConditionRule(data: NormalizedResidenceInput) {
...
export function generateResidenceValues(input: SiteGenerationInput): SiteFormData {
