...
function applySizeRule(data: NormalizedShopInput) {
...
function applyConditionRule(data: NormalizedShopInput) {
...
export function generateShopValues(input: SiteGenerationInput): SiteFormData {
