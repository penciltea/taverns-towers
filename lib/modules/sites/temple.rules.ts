...
async function applySizeRule(data: NormalizedTempleInput) {
...
async function applyConditionRule(data: NormalizedTempleInput) {
...
export async function generateTempleValues(input: SiteGenerationInput): Promise<SiteFormData> {
