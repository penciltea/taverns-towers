...
interface UIState {
    ...
    // Dialog state
    openDialog: null | 'addSettlementDialog' | 'SettlementDetailsDialog' | 'deleteConfirmationDialog' | 'sightTypeDialog' | 'filterDialog' | 'SightDetailsDialog' | 'deleteSightDialog';
