...
interface UIState {
  ...
  // Dialog state
  openDialog: null | 'SettlementDetailsDialog' | 'actionConfirmationDialog' | 'siteTypeDialog' | 'filterDialog' | 'SiteDetailsDialog' | 'siteMenuDialog' | 'deleteSiteDialog' | 'typeChangeDialog' | 'LoginDialog' | 'RegisterDialog' | 'DeleteConnectionDialog';
